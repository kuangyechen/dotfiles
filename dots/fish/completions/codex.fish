...
complete -c codex -n "__fish_codex_using_subcommand cloud" -s c -l config -d 'Override a configuration value that would otherwise be loaded from `~/.codex/config.toml`. Use a dotted path (`foo.bar.baz`) to override nested values. The `value` portion is parsed as JSON. If it fails to parse as JSON, the raw string is used as a literal' -r
complete -c codex -n "__fish_codex_using_subcommand cloud" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c codex -n "__fish_codex_using_subcommand cloud" -s V -l version -d 'Print version'
...
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a exec -d 'Run Codex non-interactively'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a login -d 'Manage login'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a logout -d 'Remove stored authentication credentials'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a mcp -d '[experimental] Run Codex as an MCP server and manage MCP servers'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a mcp-server -d '[experimental] Run the Codex MCP server (stdio transport)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a app-server -d '[experimental] Run the app server'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a completion -d 'Generate shell completion scripts'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a sandbox -d 'Run commands within a Codex-provided sandbox'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a apply -d 'Apply the latest diff produced by Codex agent as a `git apply` to your local working tree'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a resume -d 'Resume a previous interactive session (picker by default; use --last to continue the most recent)'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a generate-ts -d 'Internal: generate TypeScript protocol bindings'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a cloud -d '[EXPERIMENTAL] Browse tasks from Codex Cloud and apply changes locally'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a responses-api-proxy -d 'Internal: run the responses API proxy'
complete -c codex -n "__fish_codex_using_subcommand help; and not __fish_seen_subcommand_from exec login logout mcp mcp-server app-server completion sandbox apply resume generate-ts cloud responses-api-proxy help" -f -a help -d 'Print this message or the help of the given subcommand(s)'
